    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('uri_regex', models.CharField(default='', help_text='Regex used to filter by request URI.', max_length=100, verbose_name='Request path regex', blank=True)),
                ('user_filter_type', models.IntegerField(default=0, help_text='Filter requests by type of user.', verbose_name='User type filter', choices=[(0, 'All users (inc. None)'), (1, 'Authenticated users only'), (2, 'Users in a named group')])),
                ('user_group_filter', models.CharField(default='', help_text='Group used to filter users.', max_length=100, verbose_name='User group filter', blank=True)),
            ],
            options={
            },
            bases=(models.Model,),
