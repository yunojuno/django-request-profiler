...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'ProfilingRecord.http_referer'
        db.add_column('request_profiler_profilingrecord', 'http_referer',
                      self.gf('django.db.models.fields.CharField')(default=u'', max_length=400),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'ProfilingRecord.http_referer'
        db.delete_column('request_profiler_profilingrecord', 'http_referer')
    ...
    models = {
        ...
        'request_profiler.profilingrecord': {
            ...
            'http_referer': ('django.db.models.fields.CharField', [], {'default': "u''", 'max_length': '400'}),
